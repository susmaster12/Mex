                                ...
                                <div>
                                    <form class="login_form" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="classSelect">Какое у вас оброзование</label>
                                        ...
                                        <div class="form-group form-check">
                                            ...
                                            <div class="form-group form-check">
                                                ...
                                                <label class="form-check-label" for="acceptRules">Инженер иследователь</label><br>
                                            </div>
                                            <div class="form-group form-check">
                                                <input type="checkbox" class="form-check-input" id="acceptRules" name="accept">
                                            ...
                                            <div class="form-group form-check">
                                                <input type="checkbox" class="form-check-input" id="acceptRules" name="accept">
                                                <label class="form-check-label" for="acceptRules">Инженер по жиз</label><br>
                                            </div>
                                            <div class="form-group form-check">
                                                <input type="checkbox" class="form-check-input" id="acceptRules" name="accept">
                                                <label class="form-check-label" for="acceptRules">Инженер по р</label><br>
                                            </div>
                                            <div class="form-group form-check">
                                                <input type="checkbox" class="form-check-input" id="acceptRules" name="accept">
                                            ...
                                            <div class="form-group form-check">
                                                <input type="checkbox" class="form-check-input" id="acceptRules" name="accept">
                                                <label class="form-check-label" for="acceptRules">Экзбитолог</label><br>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="about">Почему вы участвуете?</label>
                                        ...
                                        <div class="form-group form-check">
                                            <input type="checkbox" class="form-check-input" id="acceptRules" name="accept">
                                            <label class="form-check-label" for="acceptRules">Готовы лететь на Марс</label>
                                        </div>
